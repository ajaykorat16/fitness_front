...
import img from "../../../img/unsplash_nqUHQkuVj3c.jpg";
import { useSelector } from "react-redux";
import { useNavigate } from "react-router-dom";
import { S3_BUCKET_URL } from "../../../config/constants";

const RelatedFitnessPlans = ({
  data,
  onSignUp,
  programSelector,
  showUpgradeModal,
    ...
    <div className="programfilter">
      <Row gutter={[0, 0]}>
        <Col xs={24} sm={24} md={8} lg={8}>
          <img
            src={Boolean(data.banner) ? S3_BUCKET_URL + data.banner : img}
            alt=""
          />
        </Col>
        ...
        <Col xs={24} sm={24} md={16} lg={16}>
          <div className="fitnessplans-fp">
            <h2>{data.name}</h2>
            <p className="fitheading-fp">{data.description}</p>
            <div className="coaches-ac">
              <ul>
                <li>
                  <p className="coaches-w">Coach</p>
                </li>
                <li>
            ...
            <div className="work-min-mel-all">
              <ul>
                ...
                <li>
                  <div className="wok-mbm">
                    <b>{Number.parseFloat(data.workout_count / data.days, 2).toFixed(2)}</b>
                    <p>minutes/day</p>
                  </div>
                </li>
                ...
                <li>
                  <div className="wok-mbm">
                    <b>{Number.parseFloat(data.recipe_count / data.days, 2).toFixed(2)}</b>
                    <p>MEALS/day</p>
                  </div>
                </li>
              </ul>
...
export default RelatedFitnessPlans;
